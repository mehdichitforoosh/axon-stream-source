package com.rondoiq.event.converter;
...
public class DefaultSpringMessageEventMessageConverter implements SpringMessageEventMessageConverter {
    ...
    public Message<?> toSpringMessage(EventMessage<?> eventMessage) {
        ...
        return new GenericMessage<>(serializedObject.getData(), new com.rondoiq.event.converter.DefaultSpringMessageEventMessageConverter.SettableTimestampMessageHeaders(headers, eventMessage.getTimestamp().toEpochMilli()));
